                ...
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Todo lo que necesite saber sobre BigData aqui lo encontrará!!!</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Donde nuestros profesionales pondrán a vuestra disposición el mejor material.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Para que se familiarice y le sea mas sencillo el aprendizaje</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Para poner en prácticas lo que le hemos enseñado en los cursos</p>
                        </div>
                    </div>
                </div>
            </div>
